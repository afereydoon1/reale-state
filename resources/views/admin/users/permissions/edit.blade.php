...
@section('title','داشبورد |کاربران | دسترسی ها |ویرایش دسترسی')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">ویرایش دسترسی</h4>
                        <h4 class="header-title"><a href="{{ route('permissions.index') }}" class="btn btn-danger">بازگشت</a>
                        </h4>
                    </div>
                    <form method="POST" action="{{ route('permissions.update',$permission->id) }}" id="form">
                        @csrf
                        @method('PUT')
