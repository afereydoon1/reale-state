                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="commentable" id="" class="form-control form-control-sm" id="commentable @error('commentable') is-invalid @enderror">
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="summary" id="summary"  class="form-control form-control-sm @error('summary') is-invalid @enderror" rows="6">{{ old('summary') }}</textarea>
                                @error('summary')
                                <span class="invalid-feedback font-weight-bold">
                                        {{ $message }}
                                     </span>
