    ...
    <section class="row  mt-30">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('ads.store') }}" method="POST" enctype="multipart/form-data" id="form">
                        @csrf
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="storeroom"
                                            ...
                                            id="storeroom">
                                        <option value="0" @if(old('storeroom') == 0) selected @endif>ندارد</option>
                                        <option value="1" @if(old('storeroom') == 1) selected @endif>دارد</option>
                                    </select>
                                    @error('status')
                                    <span class="invalid-feedback font-weight-bold">
                                        {{ $message }}
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="balcony"
                                            ...
                                            id="balcony">
                                        <option value="0" @if(old('balcony') == 0) selected @endif>ندارد</option>
                                        <option value="1" @if(old('balcony') == 1) selected @endif>دارد</option>
                                    </select>
                                    @error('balcony')
                                    <span class="invalid-feedback font-weight-bold">
                                        {{ $message }}
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="toilet"
                                            ...
                                            id="toilet">
                                        <option value="0" @if(old('toilet') == 0) selected @endif>ایرانی</option>
                                        <option value="1" @if(old('toilet') == 1) selected @endif>فرنگی</option>
                                        <option value="2" @if(old('toilet') == 1) selected @endif>ایرانی و فرنگی
                                        </option>
                                    </select>
                                    @error('toilet')
                                    <span class="invalid-feedback font-weight-bold">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="sell_status"
                                            ...
                                            id="sell_status">
                                        <option value="0" @if(old('sell_status') == 0) selected @endif>خرید</option>
                                        <option value="1" @if(old('sell_status') == 1) selected @endif>اجاره</option>
                                    </select>
                                    @error('sell_status')
                                    <span class="invalid-feedback font-weight-bold">
                                        {{ $message }}
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="type"
                                            ...
                                            id="balcony">
                                        <option value="0" @if(old('type') == 0) selected @endif>آپارتمان</option>
                                        <option value="1" @if(old('type') == 1) selected @endif>ویلایی</option>
                                        <option value="2" @if(old('type') == 2) selected @endif>زمین</option>
                                        <option value="3" @if(old('type') == 3) selected @endif>سوله</option>
                                    </select>
                                    @error('type')
                                    <span class="invalid-feedback font-weight-bold">
                                        {{ $message }}
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="parking"
                                            ...
                                            id="parking">
                                        <option value="0" @if(old('parking') == 0) selected @endif>ندارد</option>
                                        <option value="1" @if(old('parking') == 1) selected @endif>دارد</option>
                                    </select>
                                    @error('parking')
                                    <span class="invalid-feedback font-weight-bold">
                                        {{ $message }}
                                    ...
                                    <select name="category_id" id=""
                                        ...
                                        @foreach ($adsCategories as $adsCategory)
                                            <option value="{{ $adsCategory->id }}"
                                                    @if(old('category_id') == $adsCategory->id) selected @endif>{{ $adsCategory->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('category_id')
                                    <span class="invalid-feedback font-weight-bold">
