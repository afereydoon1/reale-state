    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 pb-2">
                <a href="{{ route('ads_categories.create') }}" class="btn btn-info btn-sm">ایجاد دسته بندی</a>
...
{{--                </div>--}}
            ...
            <section class="table-responsive">
                <table class="table table-striped table-hover" id="adsCategory">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="width-16-rem text-center">
                                <a href="{{ route('ads_categories.edit', $item->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                <form class="d-inline" action="{{ route('ads_categories.destroy', $item->id) }}" method="post">
                                    @csrf
                                    @method('delete')
